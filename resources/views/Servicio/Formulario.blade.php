  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-xs-12 col-sm-12">
        <h1>Bienvenido a Registro del tipo de servicio </h1>
        <form action="{{action('ServicioController@insertar')}}" method="POST">
          {{csrf_field()}}
        <div>
          <label class="form-label" form="">Nombre del tipo de servicio
          </label>
