  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-xs-12 col-sm-12">
        <h1>Bienvenido a Registro de Producto </h1>
        <form action="{{action('ProductoController@insertarp')}}" method="POST">
          {{csrf_field()}}
        <div>
          <label class="form-label" form="">Nombre del Pruducto
          </label>
          <input type="text" name="nombrep" class="form-control" value="">
        </div>
        <div>
          <label class="form-label" form="">Precio
          </label>
